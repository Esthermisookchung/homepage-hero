...
const TEXT_SPANS = [
  { id: 's0', text: 'Sesame was built to make ',      range: [0.00, 0.06] },
  { id: 's1', text: 'quality healthcare ',             range: [0.04, 0.10] },
  { id: 's2', text: 'simpler, faster, and ',           range: [0.08, 0.14] },
  { id: 's3', text: 'more affordable. ',               range: [0.12, 0.18] },
  { id: 's4', text: 'No insurance games, ',            range: [0.15, 0.22] },
  { id: 's5', text: 'no surprise bills — ',       range: [0.19, 0.26] },
  { id: 's6', text: 'just clear prices, ',             range: [0.22, 0.29] },
  { id: 's7', text: 'real doctors, ',                  range: [0.25, 0.31] },
  { id: 's8', text: 'and care whenever you need it.', range: [0.28, 0.35] },
];
// ─── Icon cards ─────────────────────────────────────────────────────────────
